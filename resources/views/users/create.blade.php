    ...
    <form method="POST" action="{{ route('users.store') }}">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-5">
            <h2 class="font-semibold text-gray-800 mb-5 flex items-center gap-2">
                <span class="material-symbols-outlined text-eids-accent">person_add</span>
                User Details
            </h2>
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="employee_id" value="{{ old('employee_id') }}" placeholder="e.g. EMP001"
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="relative">
                        <input :type="show ? 'text' : 'password'" name="password" required placeholder="Min. 8 characters"
                               class="w-full px-3.5 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-eids-accent pr-10 {{ $errors->has('password') ? 'border-red-400' : '' }}">
